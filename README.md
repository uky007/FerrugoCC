...
> **Status: v0.4.0** — Experimental compiler, not production-ready. 409 tests pass, including 24 corpus run tests across 11 real-world C projects (normal + obfuscated). See [Supported Scope](#supported-scope) and [Known Limitations](#known-limitations).
